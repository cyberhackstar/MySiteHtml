...
if ($name == "") {
    ...
    $to = 'sharma2001bhawesh@gmail.com';
    ...
    $headers .= 'From:  inbio <sharma2001bhawesh@gmail.com>' . "\r\n";
    $headers .= 'cc: sharma2001bhawesh@gmail.com' . "\r\n";
    $headers .= 'bcc: sharma2001bhawesh@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f sharma2001bhawesh@gmail.com');
